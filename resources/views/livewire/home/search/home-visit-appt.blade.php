<div>
    <div class="h-[272px]">
        ...
        <div class="flex flex-col pt-5 gap-5" wire:ignore>
            {{-- CITY DROPDOWN   --}}
            <select name="city" wire:model.lazy="cityId" data-placeholder="@lang('Select city')"
            ...
            {{-- CLINIC DROPDOWN   --}}
            <select name="clinic" wire:model.lazy="clinicId" data-placeholder="@lang('Select speciality')"
                class="search-dropdown-home-vitit-appt rounded-b-lg flex-grow bg-grey-bg2 rounded-lg py-2 px-3">
                {{-- placeholder --}}
