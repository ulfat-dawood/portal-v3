            ...
            <div>
                <div class="w-11/12 h-full mx-auto bg-grey-bg2 p-3 rounded-lg flex flex-col gap-3">
                    ...
                    <div class="flex justify-between">
                        <div>
                            <div class="font-normal">{{ $report['srvcSubcat'] }}</div>
                            <div class="text-sm text-grey-border3">{{ $report['srvcName'] }}</div>
                        </div>
                        <div class="flex-shrink-0 text-xs font-normal text-grey-border3">
                            {{ explode('T', $report['rdlgyOrderModified'])[0] }}
                        </div>
                    </div>
                    ...
                    <!-- download btn  -->
                    <div wire:click='downloadPdf({{ $report['rdlgyOrderBaseId'] }})'
