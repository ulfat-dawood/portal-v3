                    ...
                    <div class="card">
                        <div class="bg-white p-6 my-10 md:mx-auto">
                            ...
                            <div class="text-center">
                                <h1 class="font-bold text-xl my-7">@lang('Payment Successful')!</h1>
                                <p class="text-gray-400 mt-4 mb-14">@lang('The payment was successful.')</p>
                                <a href="{{ route('home') }}"
                                    class="px-12 py-3 rounded-md bg-main-500 text-white">@lang('Home page')
                                </a>
                            </div>
                        </div>
                    </div>
